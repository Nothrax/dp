...
(2, 'gateway2', 'Office Building B', 1),
(3, 'gateway3', 'Office Building C', 1);

INSERT INTO device (id, device_type, device_number, device_name, placement, gateway_id) VALUES
(1, 2, 1, 'vaha1', 'Floor 1, Room 101', 1),
(2, 2, 2, 'vaha2', 'Floor 1, Room 101', 2),
(3, 1, 3, 'sklep1', 'Floor 2, Room 201', 3);

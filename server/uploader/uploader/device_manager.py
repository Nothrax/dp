...
class DeviceManager:
    ...
    def load_devices(self) -> None:
        ...
        self._company_device_registry.add_device("company1", "gateway1", DeviceType.SCALE, 1, "randomTokenValue")
        self._company_device_registry.add_device("company1", "gateway1", DeviceType.CELLAR, 1, "randomTokenValue")
        return

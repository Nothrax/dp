...
class Config:
    def __init__(self, address, port, ssl, ca_cert, cert_file, keyfile, influxdb_address, db_address, db_user, db_password):
...
def load_config(json_file_path):
    try:
        with open(json_file_path, 'r') as json_file:
            ...
            return Config(address, port, ssl, ca_cert, cert_file, keyfile, influxdb_address, db_address, db_user, db_password)
